...
return (
  <div className="flex-1 max-w-[800px] bg-white rounded-[4px] p-4 shadow-sm border border-gray-200">
    ...
    {filteredProjets.length === 0 ? (
      <div className="text-center py-8">Aucun projet {projetFilter.toLowerCase()} trouvé.</div>
    ) : (
      <>
        <div className="grid grid-cols-2 gap-4">
          {currentProjets.map((projet) => (
            <div key={projet._id} className="border border-gray-200 rounded-[4px] p-3">
        ...
        {/* Pagination déplacée en dessous des projets */}
