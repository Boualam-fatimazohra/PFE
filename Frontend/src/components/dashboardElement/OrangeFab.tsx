...
interface Partenariat {
  ...
  startupNom: string;
  entiteOrange: string;
  statutNegociation: 'Initial' | 'En Discussion' | 'Négociation' | 'Signé' |'Exploration' |'En attent';
...
const OrangeFab = () => {
  ...
  const partenariats: Partenariat[] = [
    ...
    {
      id: "PAR3",
      startupNom: "GreenTech",
      entiteOrange: "Orange Energy",
      statutNegociation: "En attent",
      dateInitiation: "2023-12-10"
    },
    {
      id: "PAR4",
      startupNom: "CyberSecure",
      entiteOrange: "Orange Cyberdefense",
      statutNegociation: "Signé",
      dateInitiation: "2024-01-20"
    },
    {
      id: "PAR5",
      startupNom: "AI Dynamics",
      entiteOrange: "Orange AI Lab",
      statutNegociation: "Exploration",
      dateInitiation: "2024-04-05"
    }
];
    ...
    <div className="min-h-screen bg-white p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-3 gap-6 mt-6">
          ...
          <Card className="border-gray-200 rounded-md shadow-sm col-span-2">
            <CardHeader>
              <CardTitle className="flex justify-between items-center">
  ...
  {/* Partenariats */}
  <Card className="border-gray-200 rounded-md shadow-sm h-[420px]"> {/* Increased height */}
            <CardHeader className="flex flex-row justify-between items-center space-x-4"> {/* Adjusted layout */}
              <CardTitle className="flex-grow">Partenariats</CardTitle>
              <div className="flex items-center space-x-2"> {/* Aligned buttons */}
                <Button variant="ghost" className="text-[#333] flex items-center gap-2 font-bold">
                  <svg
                    width="16"
                    height="16"
            ...
            <CardContent className="overflow-y-auto"> {/* Added scrolling if content overflows */}
              {partenariats.map((part) => (
                <div key={part.id} className="border-b py-2 last:border-b-0">
                  <div className="flex justify-between items-center">
                    <span className="font-medium">{part.startupNom}</span>
                    <span className="text-sm text-orange-600">{part.statutNegociation}</span>
                  </div>
                  <div className="text-sm text-gray-500">
                    {part.entiteOrange} - {part.dateInitiation}
                  </div>
                </div>
              ))}
            </CardContent>
