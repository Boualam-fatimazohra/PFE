      ...
      <CardContent>
        <div className="flex items-center gap-2 mb-4">
          <Button 
            ...
            className={activeVille === "Tous" ? "bg-orange-500 text-white hover:bg-orange-600" : "bg-gray-200 text-gray-700 hover:bg-gray-300 border-none"}
            size="sm"
          ...
          <Button 
            ...
            className={activeVille === "Rabat" ? "bg-orange-500 text-white hover:bg-orange-600" : "bg-gray-200 text-gray-700 hover:bg-gray-300 border-none"}
            size="sm"
          ...
          <Button 
            ...
            className={activeVille === "Agadir" ? "bg-orange-500 text-white hover:bg-orange-600" : "bg-gray-200 text-gray-700 hover:bg-gray-300 border-none"}
            size="sm"
          ...
          <Button 
            ...
            className={activeVille === "Casablanca" ? "bg-orange-500 text-white hover:bg-orange-600" : "bg-gray-200 text-gray-700 hover:bg-gray-300 border-none"}
            size="sm"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredFormateurs.map((formateur) => (
            <div key={formateur.id} className="  p-4 flex flex-col">
              <div className="flex items-start mb-2">
                ...
                <span
                  className="bg-orange-100 text-orange-400 px-3 py-1 rounded-full text-sm font-semibold"
              ...
              {!formateur.enFormation && formateur.disponible && (
                <span
                  className="bg-gray-100 text-gray-500 px-3 py-1 rounded-full text-sm font-semibold"
                  style={{ fontFamily: "Inter" }}
                >
                  Disponible
                </span>
            ...
            variant="default"
            size="sm"
            className="bg-black text-white hover:bg-gray-900 rounded-md px-4 py-0 text-sm font-medium transition duration-200"
