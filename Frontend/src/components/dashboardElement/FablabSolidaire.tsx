      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link to="/manager/CalendrierFablab" className="bg-orange-500 text-white px-4 py-2 rounded-[4px] shadow-md hover:bg-orange-600">
  ...
  <div className="space-y-4">
    {equipements.map((equip) => (
      ...
      >
        <div className="flex items-center">
          <div className=" mr-3">
          <img src={equip.image}  className="w-[50px] h-[40px] object-cover" />
          </div>
          <div>
